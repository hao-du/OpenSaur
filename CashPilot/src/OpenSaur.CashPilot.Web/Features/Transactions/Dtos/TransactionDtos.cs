...
public sealed record MarkerCalendarQueryRequest(string TagName, DateOnly? StartDate, DateOnly? EndDate);

public sealed record MarkerPeriodsQueryRequest(Guid MakerId);
