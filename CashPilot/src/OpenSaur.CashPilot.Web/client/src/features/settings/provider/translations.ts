export const translations = {
  en: {
    ...
    "transactions.createCashFlow": "CashFlow",
    "transactions.createTitle": "Create cashflow",
    "transactions.currency": "Currency",
    "transactions.delete": "Delete",
    "transactions.deleteConfirm": "Are you sure you want to delete {name}?",
    "transactions.deleteTitle": "Delete transaction",
    "transactions.description": "Description",
    "transactions.direction": "Direction",
    "transactions.edit": "Edit",
    "transactions.editTitle": "Edit cashflow",
    "transactions.emptySubtitle": "Create a cashflow to start tracking transactions.",
    "transactions.emptyTitle": "No transactions found",
    "transactions.errorDelete": "Unable to delete transaction.",
    "transactions.errorLoadCurrencies": "Unable to load currencies.",
    "transactions.errorSave": "Unable to save transaction.",
    "transactions.expense": "Expense",
    "transactions.income": "Income",
    "transactions.isIncome": "Is Income",
    "transactions.loading": "Loading transactions...",
    "transactions.save": "Save",
    "transactions.subtitle": "Manage cashflow transactions.",
    "transactions.title": "Transactions",
    "transactions.transactedOn": "Transacted On",
    "transactions.type": "Type",
    "transactions.validation.amountInvalid": "Amount must be greater than zero.",
    "transactions.validation.amountRequired": "Amount is required.",
    "transactions.validation.currencyRequired": "Currency is required.",
    "transactions.validation.transactedOnRequired": "Transaction date is required.",
  },
  vi: {
    ...
    "transactions.createCashFlow": "Dòng tiền",
    "transactions.createTitle": "Tạo dòng tiền",
    "transactions.currency": "Tiền tệ",
    "transactions.delete": "Xóa",
    "transactions.deleteConfirm": "Bạn có chắc muốn xóa {name}?",
    "transactions.deleteTitle": "Xóa giao dịch",
    "transactions.description": "Mô tả",
    "transactions.direction": "Luồng",
    "transactions.edit": "Sửa",
    "transactions.editTitle": "Sửa dòng tiền",
    "transactions.emptySubtitle": "Tạo dòng tiền để bắt đầu theo dõi giao dịch.",
    "transactions.emptyTitle": "Không tìm thấy giao dịch",
    "transactions.errorDelete": "Không thể xóa giao dịch.",
    "transactions.errorLoadCurrencies": "Không thể tải danh sách tiền tệ.",
    "transactions.errorSave": "Không thể lưu giao dịch.",
    "transactions.expense": "Chi",
    "transactions.income": "Thu",
    "transactions.isIncome": "Là khoản thu",
    "transactions.loading": "Đang tải giao dịch...",
    "transactions.save": "Lưu",
    "transactions.subtitle": "Quản lý giao dịch dòng tiền.",
    "transactions.title": "Giao dịch",
    "transactions.transactedOn": "Ngày giao dịch",
    "transactions.type": "Loại",
    "transactions.validation.amountInvalid": "Số tiền phải lớn hơn 0.",
    "transactions.validation.amountRequired": "Số tiền là bắt buộc.",
    "transactions.validation.currencyRequired": "Tiền tệ là bắt buộc.",
    "transactions.validation.transactedOnRequired": "Ngày giao dịch là bắt buộc.",
  }
} as const;
