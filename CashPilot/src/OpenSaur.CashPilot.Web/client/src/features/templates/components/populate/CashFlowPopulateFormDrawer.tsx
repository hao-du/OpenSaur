...
import { CashFlowPopulateForm } from "./CashFlowPopulateForm";
...
export function CashFlowPopulateFormDrawer({
  isOpen,
  onClose,
  t,
  todayIsoDate,
  ...
  return (
    <Drawer
      isOpen={isOpen}
      onClose={onClose}
      title={`${t("templates.populate")} ${t("templates.templateType.cashFlow")}`}
      width="wide"
    >
      <DrawerHeader />
