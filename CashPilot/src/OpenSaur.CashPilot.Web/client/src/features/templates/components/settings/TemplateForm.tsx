...
export function buildDefaultTemplateData(type: TemplateType): TemplateData {
  ...
  return { accountNumber: f(""), amount: f(""), bankId: f(""), currencyId: f(""), description: f(""), interestRate: f(""), maturityDate: f(""), startDate: f(""), status: f("1"), details: [] } satisfies BankAccountTemplateData;
}
