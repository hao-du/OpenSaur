        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExchangeDate = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Counterparties_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Currencies_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransferType = table.Column<byte>(type: "smallint", nullable: false),
                    Amount = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
                    CurrencyId = table.Column<Guid>(type: "uuid", nullable: false),
                    TransactionDate = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BankAccountTransactions_Transactions_TransactionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CurrencyExchangeTransactions_CurrencyExchanges_CurrencyExch~",
                        column: x => x.CurrencyExchangeId,
                        principalTable: "CurrencyExchanges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CurrencyExchangeTransactions_Transactions_TransactionId",
                        column: x => x.TransactionId,
                        principalTable: "Transactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransferTransactions_Transactions_TransactionId",
                        column: x => x.TransactionId,
                        principalTable: "Transactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankAccountTransactions_TransactionId",
                table: "BankAccountTransactions",
                column: "TransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_Banks_OwnerId_ShortName",
                table: "Banks",
                columns: new[] { "OwnerId", "ShortName" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Counterparties_OwnerId_FullName",
                table: "Counterparties",
                columns: new[] { "OwnerId", "FullName" });

            migrationBuilder.CreateIndex(
                name: "IX_Currencies_OwnerId_ShortName",
                table: "Currencies",
                columns: new[] { "OwnerId", "ShortName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CurrencyExchangeTransactions_CurrencyExchangeId",
                table: "CurrencyExchangeTransactions",
                column: "CurrencyExchangeId");

            migrationBuilder.CreateIndex(
                name: "IX_CurrencyExchangeTransactions_TransactionId",
                table: "CurrencyExchangeTransactions",
                column: "TransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_Templates_OwnerId_TemplateType_Name",
                table: "Templates",
                columns: new[] { "OwnerId", "TemplateType", "Name" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransferTransactions_TransactionId",
