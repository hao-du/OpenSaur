...
**Do not commit files unless the user explicitly asks you to commit.**

When ending a work session, complete the applicable steps below without creating commits or pushing code unless explicitly requested:

1. **File issues for remaining work** - Create issues for anything that needs follow-up
2. **Run quality gates** (if code changed) - Tests, linters, builds
3. **Update issue status** - Close finished work, update in-progress items
4. **Hand off** - Provide context for next session, including changed files and verification results
...
- Do NOT say work is committed or pushed unless you have actually done it in response to an explicit request
