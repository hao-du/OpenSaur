...
- [x] 2.5 Store callback and post-logout paths per managed client instead of relying on global OIDC suffix settings
...
- [x] 3.4 Allow editing client-owned callback and post-logout paths in the admin UI
