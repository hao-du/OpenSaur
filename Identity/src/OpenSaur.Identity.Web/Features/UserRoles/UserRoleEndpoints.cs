...
using OpenSaur.Identity.Web.Features.UserRoles.GetAvailableRoles;
...
using OpenSaur.Identity.Web.Features.UserRoles.GetUserAssignments;
...
public static class UserRoleEndpoints
{
    public static IEndpointRouteBuilder MapUserRoleEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        userRoles.MapGet("/getavailableroles", GetAvailableRolesHandler.HandleAsync);
        ...
        userRoles.MapGet("/getbyuser/{userId:guid}", GetUserAssignmentsHandler.HandleAsync)
            .RequireUserManagementAccess();
        userRoles.MapGet("/getrolecandidates", GetRoleCandidatesHandler.HandleAsync)
            .RequireUserManagementAccess();
