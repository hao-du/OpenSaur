...
namespace OpenSaur.Identity.Web.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260322132732_RequirePasswordChangeOnUsers")]
    partial class RequirePasswordChangeOnUsers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OpenSaur.Identity.Web.Domain.Identity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAENLoUJMaZDYSIyqN+9f2mIif4gyyOql7xr05t+ucKjmRTuoTQWtNva/D0b80LGlKRA==",
