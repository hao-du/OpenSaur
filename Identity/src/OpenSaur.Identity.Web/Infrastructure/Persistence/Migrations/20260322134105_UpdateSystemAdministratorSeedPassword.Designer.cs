...
namespace OpenSaur.Identity.Web.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260322134105_UpdateSystemAdministratorSeedPassword")]
    partial class UpdateSystemAdministratorSeedPassword
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OpenSaur.Identity.Web.Domain.Permissions.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("67be05c0-1f88-4a2c-86f4-d97ad4589135"),
                            CreatedOn = new DateTime(2026, 3, 22, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Allows administrator management operations.",
                            IsActive = true,
                            Name = "Can Manage"
                        });
                });
